...
interface IconStopwatchProps extends IconProps { }

export const IconStopwatch: SFC<IconStopwatchProps> = (props) => (
  <Icon {...props} name="icon-stopwatch" width={14} height={16}>
    <g fill="none">
